...
check("AGP 9.3 toolchain", 'com.android.application") version "9.3.0"' in ROOT_BUILD_GRADLE)
check("Kotlin 2.4 toolchain", 'org.jetbrains.kotlin.plugin.compose") version "2.4.0"' in ROOT_BUILD_GRADLE and 'id("org.jetbrains.kotlin.android")' not in ROOT_BUILD_GRADLE and 'id("org.jetbrains.kotlin.android")' not in BUILD_GRADLE)
