...
check("v0.4.3 release metadata", 'versionName = "0.4.3"' in BUILD_GRADLE and "versionCode = 44" in BUILD_GRADLE and (ROOT / "RELEASE_NOTES_v0.4.3.md").exists() and (ROOT / "docs/V0.4_RESEARCH_AND_PRODUCT_PLAN.md").exists())
