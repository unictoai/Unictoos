...
check("v0.4.8 release metadata", 'versionName = "0.4.8"' in BUILD_GRADLE and "versionCode = 49" in BUILD_GRADLE and (ROOT / "VERSION").read_text().strip() == "0.4.8" and (ROOT / "RELEASE_NOTES_v0.4.8.md").exists() and (ROOT / "docs/V0.4_RESEARCH_AND_PRODUCT_PLAN.md").exists())
