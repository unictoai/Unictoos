...
check("v0.4.2 release metadata", 'versionName = "0.4.2"' in BUILD_GRADLE and "versionCode = 43" in BUILD_GRADLE and (ROOT / "RELEASE_NOTES_v0.4.2.md").exists() and (ROOT / "docs/V0.4_RESEARCH_AND_PRODUCT_PLAN.md").exists())
